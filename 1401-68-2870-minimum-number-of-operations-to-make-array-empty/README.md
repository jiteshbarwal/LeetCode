<h2> 1401 68
2870. Minimum Number of Operations to Make Array Empty</h2><hr><div><p>You are given a <strong>0-indexed</strong> array <code>nums</code> consisting of positive integers.</p>
